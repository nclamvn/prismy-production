-- =====================================================
-- PRISMY MVP: INVITE + CREDIT SYSTEM MIGRATION
-- Date: 2025-06-24
...
RETURNS TEXT AS $$
BEGIN
  RETURN encode(digest(code || current_setting('app.invite_salt', TRUE), 'sha256'), 'hex');
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;
...
-- INSERT INTO schema_migrations (version) VALUES ('20250624_invite_credit_system');