-- Clean MVP Credit & Invitation System Schema
...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'purchased_credits', 0, -- TODO: Track purchased vs trial credits
    'trial_ends_at', NULL -- TODO: Add trial end date if needed
  );
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;
...
CREATE FUNCTION create_invitation_code(
