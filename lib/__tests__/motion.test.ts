...
describe('Motion System', () => {
  ...
  describe('NotebookLM Variants', () => {
    ...
    it('should define notebookLMButton correctly', () => {
      ...
      expect(notebookLMButton.whileHover.transition.duration).toBe(
        DURATION.short1
      )
      expect(notebookLMButton.whileTap.transition.duration).toBe(
        DURATION.short1
      )
    })
  })
  ...
  describe('Vietnamese Cultural Rhythms', () => {
    ...
    it('should define evening rhythm', () => {
      ...
      expect(eveningRhythm.visible.transition.duration).toBe(
        DURATION.meditation
      )
    })
  ...
  describe('Material Design Compliance', () => {
    it('should use Material Design 3 durations', () => {
      const {
        notebookLMEasing,
        notebookLMEmphasized,
        notebookLMDecelerate,
      } = require('../motion')
