...
describe('Constants', () => {
  ...
  describe('Subscription Tiers', () => {
    ...
    it('should match quality tiers', () => {
      ...
      expect(Object.values(qualityTiers)).toEqual(Object.values(subscriptionTiers))
    })
  })
  ...
  describe('Rate Limits', () => {
    ...
    it('should have increasing limits for higher tiers', () => {
      ...
      expect(rateLimits.PREMIUM?.limit).toBeGreaterThan(rateLimits.STANDARD?.limit)
      expect(rateLimits.ENTERPRISE?.limit).toBeGreaterThan(rateLimits.PREMIUM?.limit)
    })
  ...
  describe('Validation', () => {
    ...
    it('should validate API endpoint format', () => {
      const isValidEndpoint = (endpoint: string) => /^\/api\/[a-z]+/.test(endpoint)
