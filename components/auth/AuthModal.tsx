...
export default function AuthModal({ isOpen, onClose, initialMode = 'signin', language = 'en' }: AuthModalProps) {
          ...
          >
            <div className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {mode === 'signup' && (
                  <div>
                    <label htmlFor="fullName" className="block body-sm font-medium text-gray-700 mb-2">
                    ...
                    <input
                      ...
                      placeholder={content[language].signup.fullNamePlaceholder}
                    />
                  </div>
                )}

                <div>
                  <label htmlFor="email" className="block body-sm font-medium text-gray-700 mb-2">
                ...
                <div>
                  <label htmlFor="password" className="block body-sm font-medium text-gray-700 mb-2">
                  ...
                  <input
                    ...
                    className="input-base"
                    placeholder={content[language][mode].passwordPlaceholder}
                    minLength={6}
                  />
                </div>
              ...
              <div className="mt-6">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-gray-500">{content[language].social.orContinueWith}</span>
                  </div>
                </div>
              ...
              <div className="text-center mt-6">
                <p className="body-sm text-gray-600">
                  {mode === 'signin' ? content[language].signin.noAccount : content[language].signup.hasAccount}
                  {' '}
                  <button
                    type="button"
                    onClick={toggleMode}
                  ...
                  >
                    {mode === 'signin' ? content[language].signin.switchToSignup : content[language].signup.switchToSignin}
                  </button>
                </p>
              </div>
            </div>
