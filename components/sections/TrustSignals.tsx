        ...
        items: [
          {
            name: 'SOC 2 Type II',
            icon: Shield,
            description: 'Bảo mật dữ liệu enterprise',
          },
          {
            name: 'GDPR',
            icon: Lock,
            description: 'Tuân thủ quy định châu Âu',
          },
          {
            name: 'ISO 27001',
            icon: Award,
            description: 'Quản lý bảo mật thông tin',
          },
      ...
      features: {
        ...
        items: [
          ...
          },
          {
            ...
            description: 'Xóa hoàn toàn sau khi dịch',
            icon: Shield,
          },
          {
            title: 'Hỗ trợ 24/7',
          ...
          {
            title: 'SLA 99.9%',
            description: 'Cam kết về chất lượng dịch vụ',
            icon: Award,
          },
          {
            title: 'Tích hợp API',
            description: 'Dễ dàng tích hợp vào hệ thống',
            icon: Zap,
          },
          {
        ...
        items: [
          {
            name: 'SOC 2 Type II',
            icon: Shield,
            description: 'Enterprise data security',
          },
      ...
      features: {
        ...
        items: [
          ...
          },
          {
            ...
            description: 'Complete deletion after translation',
            icon: Shield,
          },
          {
            title: '24/7 support',
            description: 'Professional support team',
            icon: Users,
          },
          {
            title: '99.9% SLA',
            description: 'Service quality commitment',
            icon: Award,
          },
          {
            title: 'API integration',
            description: 'Easy system integration',
            icon: Zap,
          },
          {
            title: 'Free training',
        ...
        >
          <div className="inline-flex items-center px-6 py-3 bg-green-50 border border-green-200 rounded-full">
            ...
            <span className="text-green-800 font-medium">
              {language === 'vi'
                ? 'Được bảo vệ bởi mã hóa cấp ngân hàng'
