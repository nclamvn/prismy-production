...
export default function ProductShowcase() {
  ...
  const content = {
    vi: {
      ...
      subtitle: "Khám phá cách Prismy thay đổi hoàn toàn quy trình dịch thuật của bạn",
      features: [
        {
          icon: Zap,
          title: "Dịch tức thì",
    ...
    en: {
      ...
      subtitle: "Discover how Prismy completely transforms your translation workflow",
      features: [
        {
          icon: Zap,
            ...
            <div className="bg-gray-100 rounded-3xl p-8 shadow-2xl">
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-sm text-gray-500">Prismy Translation</div>
                </div>
                
                <div className="space-y-4">
                  <div className="p-4 bg-gray-100 rounded-lg">
                    <div className="text-sm text-gray-500 mb-2">Input (English)</div>
                    <div className="text-gray-900">Hello, this is a demo translation...</div>
                  </div>
                  ...
                  <div className="p-4 bg-gray-200 rounded-lg">
                    <div className="text-sm text-gray-500 mb-2">Output (Vietnamese)</div>
                    <div className="text-gray-900">Xin chào, đây là bản dịch demo...</div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="text-left">
              ...
              <div className="space-y-6">
                {/* Cost Comparison */}
                <div>
                  <div className="text-sm text-gray-600 mb-2">{language === 'vi' ? 'Chi phí' : 'Cost'}</div>
                  <div className="flex items-center space-x-3">
                    <div className="flex-1">
                      <div className="h-6 bg-gray-400 rounded" style={{ width: '90%' }}></div>
                    </div>
                    <div className="text-xs text-gray-500">{language === 'vi' ? 'Trước' : 'Before'}</div>
                  </div>
                  <div className="flex items-center space-x-3 mt-2">
                    <div className="flex-1">
                      <div className="h-6 bg-gray-800 rounded" style={{ width: '20%' }}></div>
                    </div>
                    <div className="text-xs text-gray-500">{language === 'vi' ? 'Sau' : 'After'}</div>
                  </div>
                </div>

                {/* Time Comparison */}
                <div>
                  <div className="text-sm text-gray-600 mb-2">{language === 'vi' ? 'Thời gian' : 'Time'}</div>
                  <div className="flex items-center space-x-3">
                    <div className="flex-1">
                      <div className="h-6 bg-gray-400 rounded" style={{ width: '85%' }}></div>
                    </div>
                    <div className="text-xs text-gray-500">{language === 'vi' ? 'Trước' : 'Before'}</div>
                  </div>
                  <div className="flex items-center space-x-3 mt-2">
                    <div className="flex-1">
                      <div className="h-6 bg-gray-800 rounded" style={{ width: '15%' }}></div>
                    </div>
                    <div className="text-xs text-gray-500">{language === 'vi' ? 'Sau' : 'After'}</div>
                  </div>
                </div>
                ...
                {/* Accuracy Comparison */}
                <div>
                  <div className="text-sm text-gray-600 mb-2">{language === 'vi' ? 'Độ chính xác' : 'Accuracy'}</div>
                  <div className="flex items-center space-x-3">
                    <div className="flex-1">
                      <div className="h-6 bg-gray-400 rounded" style={{ width: '40%' }}></div>
                    </div>
                    <div className="text-xs text-gray-500">{language === 'vi' ? 'Trước' : 'Before'}</div>
                  </div>
                  <div className="flex items-center space-x-3 mt-2">
                    <div className="flex-1">
                      <div className="h-6 bg-gray-800 rounded" style={{ width: '95%' }}></div>
                    </div>
                    <div className="text-xs text-gray-500">{language === 'vi' ? 'Sau' : 'After'}</div>
                  </div>
                </div>
