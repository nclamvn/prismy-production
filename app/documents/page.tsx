...
function DocumentsPageContent() {
  ...
  const [translatedChunks, setTranslatedChunks] = useState<Map<string, string> | null>(null)
  ...
  const content = {
    vi: {
      title: 'Dịch Tài Liệu',
      subtitle: 'Dịch toàn bộ tài liệu của bạn với độ chính xác cao và giữ nguyên định dạng',
      features: [
    ...
    en: {
      ...
      subtitle: 'Translate entire documents with high accuracy while preserving formatting',
      features: [
            ...
            <>
              ...
              {isProcessing && (
                ...
                >
                  ...
                  <p className="body-lg text-gray-600">{content[language].processing}</p>
                </motion.div>
              )}
              ...
              {translatedChunks && (
                ...
                >
                  ...
                  <h3 className="heading-3 text-gray-900 mb-4">{content[language].title} Complete!</h3>
