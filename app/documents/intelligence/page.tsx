...
function IntelligenceDashboardContent() {
  ...
  const content = {
    vi: {
      ...
      subtitle:
        'AI sẽ phân tích và hiểu sâu tài liệu của bạn, tạo ra những hiểu biết có giá trị và khả năng tìm kiếm thông minh',
      features: [
      ...
      signInRequired:
        'Vui lòng đăng nhập để sử dụng phân tích tài liệu thông minh',
      signIn: 'Đăng nhập',
      ...
      processingStage: {
        ...
        subtitle:
          'AI đang áp dụng nhiều tầng phân tích để hiểu sâu tài liệu của bạn',
      },
    },
    en: {
      title: 'Intelligent Document Analysis',
      subtitle:
        'AI will analyze and deeply understand your documents, creating valuable insights and intelligent search capabilities',
      features: [
      ...
      processingStage: {
        ...
        subtitle:
          'AI is applying multiple layers of analysis to deeply understand your document',
      },
    },
  }
    ...
    return (
      ...
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gray-50 rounded-lg p-3">
              ...
              <div className="body-sm font-medium text-gray-900">
                {results.structure?.metadata?.pageCount || 'N/A'}
              </div>
            </div>
            <div className="bg-gray-50 rounded-lg p-3">
              <div className="body-xs text-gray-600 mb-1">Words</div>
              <div className="body-sm font-medium text-gray-900">
                {results.structure?.metadata?.wordCount || 'N/A'}
              </div>
            </div>
            <div className="bg-gray-50 rounded-lg p-3">
              <div className="body-xs text-gray-600 mb-1">Language</div>
              <div className="body-sm font-medium text-gray-900">
                {results.structure?.metadata?.language || 'N/A'}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          ...
          {results.content?.keyEntities &&
            results.content.keyEntities.length > 0 && (
              <div className="mb-4">
                <div className="body-sm font-medium text-gray-700 mb-2">
                  Key Entities
                </div>
          ...
          <div className="space-y-3">
            {results.insights?.summary && (
              <div className="bg-green-50 rounded-lg p-4">
                ...
                <div className="body-sm text-green-800">
                  {results.insights.summary}
                </div>
              </div>
            )}
            ...
            {results.insights?.classification && (
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="body-sm text-gray-800">
                  {results.insights.classification.documentType} (
                  {results.insights.classification.domain})
                </div>
              </div>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-indigo-50 rounded-lg p-3">
              ...
              <div className="body-sm font-medium text-indigo-900">
                {Math.round((results.processingMetrics?.totalTime || 0) / 1000)}
                s
              </div>
            </div>
            <div className="bg-indigo-50 rounded-lg p-3">
            ...
            <div className="bg-indigo-50 rounded-lg p-3">
              ...
              <div className="body-sm font-medium text-indigo-900">
                {Math.round(
                  (results.processingMetrics?.confidenceScores
        ...
        >
          ...
          {!user ? (
            ...
            <>
              ...
              {documentIntelligence &&
                documentIntelligence.finalResults &&
                !showDetailedResults && (
                  <motion.div
                    className="text-center py-12"
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    <div className="max-w-2xl mx-auto">
                      ...
                      <h3 className="heading-2 text-gray-900 mb-4">
                        {content[language].analysisComplete}
                      </h3>
                      ...
                      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-8">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                          <div className="text-center">
                            ...
                            <div className="body-sm font-medium text-gray-900">
                              {documentIntelligence.quickInsights.documentType}
                            </div>
                          </div>
                          <div className="text-center">
                            <div className="body-xs text-gray-600 mb-1">
                            ...
                            <div className="body-sm font-medium text-gray-900">
                              {
                                documentIntelligence.quickInsights
                          ...
                          <div className="text-center">
                            ...
                            <div
                              className={`inline-flex items-center px-2 py-1 rounded-full border text-xs font-medium ${formatComplexity(documentIntelligence.quickInsights.complexity).color}`}
                            >
                              <span className="mr-1">
                                {
                                  formatComplexity(
                              ...
                              {
                                formatComplexity(
                                  documentIntelligence.quickInsights.complexity
                                ).label
                              }
                            </div>
                          </div>
                        ...
                        {documentIntelligence.quickInsights.keyTopics.length >
                          0 && (
                          <div className="border-t border-gray-200 pt-4">
                            ...
                            <div className="flex flex-wrap gap-2 justify-center">
                              {documentIntelligence.quickInsights.keyTopics
                                .slice(0, 6)
                                .map((topic, index) => (
                                  <span
                                    key={index}
                ...
                {error && (
                  ...
                  >
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="body-sm text-red-800 font-medium">
                          Analysis Error
                        </p>
...
export default function IntelligenceDashboard() {
  return <IntelligenceDashboardContent />
}
