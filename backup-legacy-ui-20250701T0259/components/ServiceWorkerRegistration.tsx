...
export default function ServiceWorkerRegistration({
  ...
  const [swStatus, setSwStatus] = useState<
    'loading' | 'ready' | 'update-available' | 'error' | null
  >(null)
  ...
  useEffect(() => {
    // Service Worker permanently disabled for production stability
    // Prevents console noise and caching conflicts
    if (process.env.NODE_ENV === 'development') {
      console.log('Service Worker disabled for production stability')
    }
  }, [])
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 flex-1">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  A new version of Prismy is available. Update now to get the
