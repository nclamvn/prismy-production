...
test.describe('Translation Workbench', () => {
  ...
  test('should translate text successfully', async ({ page }) => {
    const sourceTextarea = page.locator(
      'textarea[aria-label="Source text input"]'
    )
    const targetTextarea = page.locator(
      'textarea[aria-label="Target text output"]'
    )
  ...
  test('should change quality tier', async ({ page }) => {
    const qualitySelect = page.locator(
      'select[aria-label="Select quality tier"]'
    )
  ...
  test('should swap languages', async ({ page }) => {
    const sourceLangSelect = page.locator(
      'select[aria-label="Select source language"]'
    )
    const targetLangSelect = page.locator(
      'select[aria-label="Select target language"]'
    )
